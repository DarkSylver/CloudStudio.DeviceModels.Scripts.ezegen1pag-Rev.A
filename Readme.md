...
# Parsing Script – ezegen1pag - Rev. A

This **Parsing** script is designed for the **ezegen1pag** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – ezegen1pag Rev. A

Este script de **Parsing** está diseñado para el modelo **ezegen1pag** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
